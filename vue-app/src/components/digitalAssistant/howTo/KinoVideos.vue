<template>
  <div class="kino-videos">
    <VideoWrapper
      :video-items="translatedVideoItems"
...
export default {
  ...
  data() {
    const items = [
      {
        video: Constants.VIDEO_NAMES.HOW_TO_KINO_1,
        titleKey: 'reasonsToPlay',
        headlineKey: 'playNow',
      },
      {
        video: Constants.VIDEO_NAMES.HOW_TO_KINO_2,
        titleKey: 'howToPlay',
        headlineKey: 'playNow',
      },
    ];
