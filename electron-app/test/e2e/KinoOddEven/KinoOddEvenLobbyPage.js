...
////////////////////////////////////////// Play Kino Odd/Even from Lobby Page /////////////////////////////////////////////

describe('TC KinoOddEvenLobbyPage.js: Play Kino Odd/Even from Lobby Page', function () {
  ...
  /////////////////////////////////////////// Select Odd/Even game from Lobby ////////////////////////////////////////////////

  it('Select Odd/Even game from Lobby', function () {
  ...
  it('Check approve and print fields', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoBetslipSubmitLbl).should.eventually.be.equal('ΑΠΟΔΟΧΗ'),
      this.app.client.getText(elements.KinoBetslipCostLbl).should.eventually.be.equal('ΚΟΣΤΟΣ ΔΕΛΤΙΟΥ\n5.5€'),
      this.app.client.getText(elements.KinoBetslipCost).should.eventually.be.equal('5.5€'),
    ]);
  });
  ...
  it('Check that KINO Bonus is selected', function () {
