...
describe('TC PowerspinAdditionalMarkets_el.js: Powerspin tests - Markets', function () {
  ...
  it('Check Powerspin Additional Markets Numbers area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinAMNumberTitle).should.eventually.be.equal('ΠΟΙΟΣ ΑΡΙΘΜΟΣ ΘΑ ΚΛΗΡΩΘΕΙ ΣΕ ΟΠΟΙΟΝΔΗΠΟΤΕ ΤΡΟΧΟ;'),
  ...
  it('Check Powerspin Additional Markets Wheel Symbol area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinAMWheelSymbolLbl).should.eventually.be.equal('ΤΟ ΣΥΜΒΟΛΟ ΘΑ ΚΛΗΡΩΘΕΙ ΣΕ:'),
      this.app.client.getText(elements.PowerspinAMWheelSymbolNoneBtn).should.eventually.be.equal('ΚΑΝΕΝΑΝ ΤΡΟΧΟ'),
      this.app.client.getText(elements.PowerspinAMWheelSymbolAtleast1Btn).should.eventually.be.equal('ΤΟΥΛΑΧΙΣΤΟΝ 1 ΤΡΟΧΟ'),
    ])
  })

  it('Check Powerspin Additional Markets Wheel Number area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinAMWheelNumberLbl).should.eventually.be.equal('ΣΕ ΠΟΣΟΥΣ ΤΡΟΧΟΥΣ ΘΑ ΚΛΗΡΩΘΕΙ Ο ΙΔΙΟΣ ΑΡΙΘΜΟΣ;'),
      this.app.client.getText(elements.PowerspinAMWheelNumber2WheelsBtn).should.eventually.be.equal('2 ΤΡΟΧΟΥΣ'),
      this.app.client.getText(elements.PowerspinAMWheelNumber3WheelsBtn).should.eventually.be.equal('3 ΤΡΟΧΟΥΣ'),
    ])
  })
  ...
  it('Check cost and selection on sidescreen', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinAMSidescreenNumbers).should.eventually.be.equal('ΠΟΣΟ: 1.5€'),
      ...
      this.app.client.getText(elements.PowerspinAMSidescreenWheelSymbol).should.eventually.be.equal('ΠΟΣΟ: 0.5€'),
      ...
      this.app.client.getText(elements.PowerspinAMSidescreenWheelNumber).should.eventually.be.equal('ΠΟΣΟ: 1€'),
  ...
  it('Confirm Clear All', function () {
    let self = this
    return Promise.all([
      this.app.client.elements(elements.PowerspinModalAMsgLbl).getAttribute('innerText').should.eventually.be.equal('ΚΑΘΑΡΙΣΜΟΣ ΔΕΛΤΙΟΥ'),
      this.app.client
        .elements(elements.PowerspinModalAMsg)
        .getAttribute('innerText')
        .should.eventually.be.equal('Όλες οι επιλογές του δελτίου θα διαγραφούν. Είστε σίγουρος/η ότι θέλετε να συνεχίσετε;'),
      this.app.client.elements(elements.PowerspinModalAYesBtn).getAttribute('innerText').should.eventually.be.equal('Ναι'),
      this.app.client.elements(elements.PowerspinModalANoBtn).getAttribute('innerText').should.eventually.be.equal('Όχι'),
  ...
  it('Check cost and selection on sidescreen', function () {
    return Promise.all([
      //this.app.client.getText(elements.PowerspinAMSidescreenNumbers).should.eventually.be.equal('ΠΟΣΟ: 1€'),  // powerspin tests
      // this.app.client.getText(elements.PowerspinAMSidescreenNumbersTxt).should.eventually.be.equal('icon'),
      // this.app.client.getText(elements.PowerspinAMSidescreenNumbersContent).should.eventually.be.equal('1\n10'),
      // this.app.client.isVisible(elements.PowerspinAMSidescreenNumbersClear).should.eventually.be.true,

      this.app.client.getText(elements.PowerspinAMSidescreenWheelSymbol).should.eventually.be.equal('ΠΟΣΟ: 1€'),
      this.app.client.getText(elements.PowerspinAMSidescreenWheelSymbolTxt).should.eventually.be.equal('ΑΡΙΘΜΟΣ (ΟΤ) :'),
      this.app.client.getText(elements.PowerspinAMSidescreenWheelSymbolContent).should.eventually.be.equal('7\n18'),
      this.app.client.isVisible(elements.PowerspinAMSidescreenWheelSymbolClear).should.eventually.be.true,

      this.app.client.getText(elements.PowerspinAMSidescreenWheelNumber).should.eventually.be.equal('ΠΟΣΟ: 0.5€'),
      this.app.client.getText(elements.PowerspinAMSidescreenWheelNumberTxt).should.eventually.be.equal('ΣΥΜΒΟΛΟ ΣΕ :'),
      this.app.client.getText(elements.PowerspinAMSidescreenWheelNumberContent).should.eventually.be.equal('ΚΑΝΕΝΑΝ ΤΡΟΧΟ'),
      this.app.client.isVisible(elements.PowerspinAMSidescreenWheelNumberClear).should.eventually.be.true,
    ])
  })
