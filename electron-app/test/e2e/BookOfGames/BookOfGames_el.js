...
describe('TC BookOfGames_en.js: Check elements of BookOfGames Bet Page', function () {
  ...
  it('Check return to Main Menu element', function () {
    return this.app.client
      .getText(elements.LobbyBookOfGames)
      .should.eventually.be.equal('ΟΔΗΓΟΙ ΠΑΙΓΝΙΩΝ\nΠΕΡΙΣΣΟΤΕΡΑ');
  });
  ...
  it('Check header text', function () {
    return this.app.client
      ...
      .should.eventually.be.equal(
        'ΟΔΗΓΟΙ ΠΑΙΓΝΙΩΝ\nΣκανάρεις τους ακόλουθους κωδικούς QR και διαβάζεις τον αντίστοιχο οδηγό παιγνίων',
      );
  });
  ...
  it('Close Application', async function () {
    this.timeout(5000);
