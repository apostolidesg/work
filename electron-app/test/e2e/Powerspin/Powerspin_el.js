...
describe('TC Powerspin_el.js: Powerspin tests', function () {
  ...
  it('Check Powerspin Number area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinNumberLbl).should.eventually.be.equal('ΑΡΙΘΜΟΣ'),
      this.app.client.getText(elements.PowerspinNumberTitle).should.eventually.be.equal('Αριθμός'),
      this.app.client.getText(elements.Powerspin2daTitle).should.eventually.be.equal('2άδα'),
      this.app.client.getText(elements.Powerspin3daTitle).should.eventually.be.equal('3άδα'),
      this.app.client.getText(elements.Powerspin4daTitle).should.eventually.be.equal('4άδα'),
      this.app.client.getText(elements.Powerspin6daTitle).should.eventually.be.equal('6άδα'),
      this.app.client.getText(elements.Powerspin8daTitle).should.eventually.be.equal('8άδα'),
      this.app.client.getText(elements.Powerspin12daTitle).should.eventually.be.equal('12άδα'),
      ...
      this.app.client.getText(elements.PowerspinRandomSelectionBtn).should.eventually.be.equal('ΤΥΧΑΙΑ ΕΠΙΛΟΓΗ'),
    ])
  })

  it('Check Powerspin Symbol area elements', function () {
    return Promise.all([this.app.client.getText(elements.PowerspinSymbolLbl).should.eventually.be.equal('ΣΥΜΒΟΛΟ'), this.app.client.isVisible(elements.PowerspinWheelImg).should.eventually.be.true])
  })

  it('Check Powerspin Zone area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinZoneLbl).should.eventually.be.equal('ΖΩΝΗ'),
      this.app.client.getText(elements.PowerspinRedBtn).should.eventually.be.equal('ΚΟΚΚΙΝΗ'),
      this.app.client.getText(elements.PowerspinGreenBtn).should.eventually.be.equal('ΠΡΑΣΙΝΗ'),
      this.app.client.getText(elements.PowerspinBlueBtn).should.eventually.be.equal('ΜΠΛΕ'),
    ])
  })
  ...
  it('Check Powerspin Combo 2 Number area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinCombo2NumberTitle).should.eventually.be.equal('ΑΡΙΘΜΟΣ'),
      ...
      this.app.client.getText(elements.PowerspinCombo2RandomSelectionBtn).should.eventually.be.equal('ΤΥΧΑΙΑ ΕΠΙΛΟΓΗ'),
    ])
  })

  it('Check Powerspin Combo 2 Symbol area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinCombo2SymbolLbl).should.eventually.be.equal('ΣΥΜΒΟΛΟ'),
  ...
  it('Check Powerspin Combo 2 Zone area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinCombo2ZoneLbl).should.eventually.be.equal('ΖΩΝΗ'),
      this.app.client.getText(elements.PowerspinCombo2RedBtn).should.eventually.be.equal('ΚΟΚΚΙΝΗ'),
      this.app.client.getText(elements.PowerspinCombo2GreenBtn).should.eventually.be.equal('ΠΡΑΣΙΝΗ'),
      this.app.client.getText(elements.PowerspinCombo2BlueBtn).should.eventually.be.equal('ΜΠΛΕ'),
    ])
  })
  ...
  it('Check Powerspin Combo 3 Number area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinCombo3NumberLbl).should.eventually.be.equal('ΑΡΙΘΜΟΣ'),
      ...
      this.app.client.getText(elements.PowerspinCombo3RandomSelectionBtn).should.eventually.be.equal('ΤΥΧΑΙΑ ΕΠΙΛΟΓΗ'),
    ])
  })

  it('Check Powerspin Combo 3 Symbol area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinCombo3SymbolLbl).should.eventually.be.equal('ΣΥΜΒΟΛΟ'),
  ...
  it('Check Powerspin Combo 3 Zone area elements', function () {
    return Promise.all([
      this.app.client.getText(elements.PowerspinCombo3ZoneLbl).should.eventually.be.equal('ΖΩΝΗ'),
      this.app.client.getText(elements.PowerspinCombo3RedBtn).should.eventually.be.equal('ΚΟΚΚΙΝΗ'),
      this.app.client.getText(elements.PowerspinCombo3GreenBtn).should.eventually.be.equal('ΠΡΑΣΙΝΗ'),
      this.app.client.getText(elements.PowerspinCombo3BlueBtn).should.eventually.be.equal('ΜΠΛΕ'),
    ])
  })
