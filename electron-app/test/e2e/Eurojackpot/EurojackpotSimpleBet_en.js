...
describe('TC EurojackpotStandardPageElements_en.js: Check elements of Eurojackpot Bet Page', function () {
  ...
  //     this.app.client.elements(elements.EurojackpotDays).getAttribute('innerText').should.eventually.be.contain('Draws'),
  //     // this.app.client.elements(elements.EurojackpotDays).getAttribute('innerText').should.eventually.be.contain('days'), //Today
  //   ])
  // })
  ...
  it('Check Statistics fields', function () {
    return Promise.all([
      this.app.client.getText(elements.EurojackpotStatisticsLbl).should.eventually.be.equal('STATISTICS'),
      this.app.client
        .getText(elements.EurojackpotStatisticsSwitchLbl)
        .should.eventually.be.equal('OCCURRENCES\nDELAYS'),
