// playwright/pageObject/powerspin/psHeader.js
...
const page = {
  combo: {
    get: function (page) {
      return page.locator('.powerspin-stepper-item');
    },
    ...
    icon: {
      get: function (page, index) {
        return page.locator('.powerspin-stepper-item__img').nth(index);
      },
    ...
    backBtn: {
      get: function (page, index) {
        return page.locator('.powerspin-stepper-item__back-btn').nth(index);
      },
      isVisible: async function (page, index) {
        await expect(this.get(page, index)).toBeVisible();
      },
  ...
  extraMarkets: {
    get: function (page) {
      return page.locator('.powerspin-header__markets-button');
    },
    text: {
      el: 'Επιπλεον Αγορες',
      en: 'Extra Markets',
    ...
    active: {
      get: function (page) {
        return page.locator('.button_active');
      },
      isVisible: async function (page) {
        await expect(this.get(page)).toBeVisible();
      },
    ...
    inactive: {
      get: function (page) {
        return page.locator('.button_inactive');
      },
      isVisible: async function (page) {
        await expect(this.get(page)).toBeVisible();
      },
