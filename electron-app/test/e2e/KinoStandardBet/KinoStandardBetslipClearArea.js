...
////////////////////////////////////////// Check Clear Area functionality from Betslip /////////////////////////////////

describe('TC KinoStandardBetslipClearArea.js: Check Clear Area functionality from Betslip', function () {
  ...
  it('Select Number 15', function () {
    return this.app.client.click(elements.KinoChooseNumber15Btn).should.eventually.be.fulfilled;
  });
  ...
  it('Select Number 25', function () {
    return this.app.client.click(elements.KinoChooseNumber25Btn).should.eventually.be.fulfilled;
  });
  ...
  it('Select Number 35', function () {
    return this.app.client.click(elements.KinoChooseNumber35Btn).should.eventually.be.fulfilled;
  });
  ...
  it('Select Number 45', function () {
    return this.app.client.click(elements.KinoChooseNumber45Btn).should.eventually.be.fulfilled;
  });
  ...
  it('Select Number 55', function () {
    return this.app.client.click(elements.KinoChooseNumber55Btn).should.eventually.be.fulfilled;
  });
  ...
  it('Select Number 65', function () {
    return this.app.client.click(elements.KinoChooseNumber65Btn).should.eventually.be.fulfilled;
  });
  ...
  it('Check betslip fields', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoBetslipAreaBCost).should.eventually.be.equal('1,50€'),
      this.app.client.isVisible(elements.KinoBetslipAreaBKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaBKinoClose2Win).should.eventually.be.true,
      ...
      this.app.client.getText(elements.KinoBetslipAreaCNumbers).should.eventually.equal('3'),
      ...
      this.app.client.getText(elements.KinoBetslipAreaDNumbers).should.eventually.equal('4'),
      this.app.client.isVisible(elements.KinoBetslipAreaE).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaECost).should.eventually.be.equal('1,50€'),
      this.app.client.isVisible(elements.KinoBetslipAreaEKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaEKinoClose2Win).should.eventually.be.true,
      ...
      this.app.client.getText(elements.KinoBetslipAreaENumbers).should.eventually.equal('5'),
      ...
      this.app.client.getText(elements.KinoBetslipAreaFNumbers).should.eventually.equal('6'),
  ...
  it('Check approve and print fields', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoBetslipCost).should.eventually.be.equal('18€'),
    ]);
  });
  ...
  it('Try to clear Area A', function () {
  ...
  it('Check betslip fields', function () {
    return Promise.all([
      this.app.client.isVisible(elements.KinoBetslipPreview).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaA).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaACost).should.eventually.be.equal('1,50€'),
      this.app.client.isVisible(elements.KinoBetslipAreaAKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaAKinoClose2Win).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaANumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaAClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaANumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n2'),
      ...
      this.app.client.isVisible(elements.KinoBetslipAreaBClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaBNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n3'),
      this.app.client.getText(elements.KinoBetslipAreaBNumbers).should.eventually.equal('3'),
      this.app.client.isVisible(elements.KinoBetslipAreaC).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaCCost).should.eventually.be.equal('1,00€'),
      this.app.client.isVisible(elements.KinoBetslipAreaCKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaCNumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaCClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaCNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n4'),
      this.app.client.getText(elements.KinoBetslipAreaCNumbers).should.eventually.equal('4'),
      this.app.client.isVisible(elements.KinoBetslipAreaD).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaDCost).should.eventually.be.equal('1,50€'),
      this.app.client.isVisible(elements.KinoBetslipAreaDKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaDKinoClose2Win).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaDNumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaDClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaDNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n5'),
      this.app.client.getText(elements.KinoBetslipAreaDNumbers).should.eventually.equal('5'),
      this.app.client.isVisible(elements.KinoBetslipAreaE).should.eventually.be.true,
      ...
      this.app.client.isVisible(elements.KinoBetslipAreaEClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaENumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n6'),
      this.app.client.getText(elements.KinoBetslipAreaENumbers).should.eventually.equal('6'),
  ...
  it('Check KINO numbers', function () {
    return Promise.all([
      ...
      this.app.client.getValue(elements.KinoChooseNumber15BtnInp).should.eventually.be.equal('true'),
      ...
      this.app.client.getValue(elements.KinoChooseNumber25BtnInp).should.eventually.be.equal('true'),
  ...
  it('Try to clear Area B', function () {
    return this.app.client.click(elements.KinoBetslipAreaAClear).should.eventually.be.fulfilled;
  });
  ...
  it('Check betslip fields', function () {
    return Promise.all([
      ...
      this.app.client.isVisible(elements.KinoBetslipAreaAClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaANumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n3'),
      this.app.client.getText(elements.KinoBetslipAreaANumbers).should.eventually.equal('3'),
      this.app.client.isVisible(elements.KinoBetslipAreaB).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaBCost).should.eventually.be.equal('1,00€'),
      this.app.client.isVisible(elements.KinoBetslipAreaBKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaBNumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaBClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaBNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n4'),
      this.app.client.getText(elements.KinoBetslipAreaBNumbers).should.eventually.equal('4'),
      this.app.client.isVisible(elements.KinoBetslipAreaC).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaCCost).should.eventually.be.equal('1,50€'),
      this.app.client.isVisible(elements.KinoBetslipAreaCKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaCKinoClose2Win).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaCNumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaCClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaCNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n5'),
      this.app.client.getText(elements.KinoBetslipAreaCNumbers).should.eventually.equal('5'),
      this.app.client.isVisible(elements.KinoBetslipAreaD).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaDCost).should.eventually.be.equal('1,00€'),
      this.app.client.isVisible(elements.KinoBetslipAreaDKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaDNumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaDClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaDNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n6'),
      this.app.client.getText(elements.KinoBetslipAreaDNumbers).should.eventually.equal('6'),
  ...
  it('Check that selected KINO numbers have been cleared', function () {
    return Promise.all([
      ...
      this.app.client.getValue(elements.KinoChooseNumber33BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber34BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber35BtnInp).should.eventually.be.equal('true'),
      this.app.client.getValue(elements.KinoChooseNumber36BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber37BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber38BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber39BtnInp).should.eventually.be.equal('false'),
  ...
  it('Try to clear Area C', function () {
    return this.app.client.click(elements.KinoBetslipAreaAClear).should.eventually.be.fulfilled;
  });
  ...
  it('Check betslip fields', function () {
    return Promise.all([
      ...
      this.app.client.isVisible(elements.KinoBetslipAreaAClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaANumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n4'),
      this.app.client.getText(elements.KinoBetslipAreaANumbers).should.eventually.equal('4'),
      this.app.client.isVisible(elements.KinoBetslipAreaB).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaBCost).should.eventually.be.equal('1,50€'),
      this.app.client.isVisible(elements.KinoBetslipAreaBKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaBKinoClose2Win).should.eventually.be.true,
      ...
      this.app.client.isVisible(elements.KinoBetslipAreaBClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaBNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n5'),
      this.app.client.getText(elements.KinoBetslipAreaBNumbers).should.eventually.equal('5'),
      this.app.client.isVisible(elements.KinoBetslipAreaC).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaCCost).should.eventually.be.equal('1,00€'),
      this.app.client.isVisible(elements.KinoBetslipAreaCKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaCNumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaCClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaCNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n6'),
      this.app.client.getText(elements.KinoBetslipAreaCNumbers).should.eventually.equal('6'),
  ...
  it('Check that selected KINO numbers have been cleared', function () {
    return Promise.all([
      ...
      this.app.client.getValue(elements.KinoChooseNumber43BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber44BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber45BtnInp).should.eventually.be.equal('true'),
      this.app.client.getValue(elements.KinoChooseNumber46BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber47BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber48BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber49BtnInp).should.eventually.be.equal('false'),
  ...
  it('Try to clear Area D', function () {
    return this.app.client.click(elements.KinoBetslipAreaAClear).should.eventually.be.fulfilled;
  });
  ...
  it('Check betslip fields', function () {
    return Promise.all([
      ...
      this.app.client.isVisible(elements.KinoBetslipAreaAClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaANumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n5'),
      this.app.client.getText(elements.KinoBetslipAreaANumbers).should.eventually.equal('5'),
      this.app.client.isVisible(elements.KinoBetslipAreaB).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaBCost).should.eventually.be.equal('1,00€'),
      this.app.client.isVisible(elements.KinoBetslipAreaBKinoBonus).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaBNumber1Value).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaBClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaBNumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n6'),
      this.app.client.getText(elements.KinoBetslipAreaBNumbers).should.eventually.equal('6'),
  ...
  it('Check approve and print fields', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoBetslipSubmitLbl).should.eventually.be.equal('ΑΠΟΔΟΧΗ'),
      this.app.client.getText(elements.KinoBetslipCostLbl).should.eventually.be.equal('ΚΟΣΤΟΣ ΔΕΛΤΙΟΥ\n9€'),
      this.app.client.getText(elements.KinoBetslipCost).should.eventually.be.equal('9€'),
    ]);
  });
  ...
  it('Check that selected KINO numbers have been cleared', function () {
    return Promise.all([
      ...
      this.app.client.getValue(elements.KinoChooseNumber53BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber54BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber55BtnInp).should.eventually.be.equal('true'),
      this.app.client.getValue(elements.KinoChooseNumber56BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber57BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber58BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber59BtnInp).should.eventually.be.equal('false'),
  ...
  it('Try to clear Area E', function () {
    return this.app.client.click(elements.KinoBetslipAreaAClear).should.eventually.be.fulfilled;
  });
  ...
  it('Check betslip fields', function () {
    return Promise.all([
      ...
      this.app.client.isVisible(elements.KinoBetslipAreaAClear).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaANumbersLbl).should.eventually.be.equal('ΑΡΙΘΜΟΙ\n6'),
      this.app.client.getText(elements.KinoBetslipAreaANumbers).should.eventually.equal('6'),
  ...
  it('Check that selected KINO numbers have been cleared', function () {
    return Promise.all([
      ...
      this.app.client.getValue(elements.KinoChooseNumber63BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber64BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber65BtnInp).should.eventually.be.equal('true'),
      this.app.client.getValue(elements.KinoChooseNumber66BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber67BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber68BtnInp).should.eventually.be.equal('false'),
      this.app.client.getValue(elements.KinoChooseNumber69BtnInp).should.eventually.be.equal('false'),
  ...
  it('Try to clear Area F', function () {
    return this.app.client.click(elements.KinoBetslipAreaAClear).should.eventually.be.fulfilled;
  });
  ...
  it('Discard Clear Area F from Areas', function () {
    let self = this;
    return Promise.all([
      this.app.client
        .elements(elements.KinoModalAMsgLbl)
  ...
  it('Check approve and print fields', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoBetslipSubmitLbl).should.eventually.be.equal('ΑΠΟΔΟΧΗ'),
      this.app.client.getText(elements.KinoBetslipCostLbl).should.eventually.be.equal('ΚΟΣΤΟΣ ΔΕΛΤΙΟΥ\n2€'),
      this.app.client.getText(elements.KinoBetslipCost).should.eventually.be.equal('2€'),
    ]);
  });
