...
////////////////////////////////////////// Play Kino Columns from Lobby Page /////////////////////////////////////////////

describe('TC KinoColumnsLobbyPage.js: Play Kino Columns from Lobby Page', function () {
  ...
  /////////////////////////////////////////// Select Columns game from Lobby ////////////////////////////////////////////////

  it('Select Columns game from Lobby', function () {
    return this.app.client.click(elements.LobbyColumns).should.eventually.be.fulfilled;
  });
  ...
  it('Check full betslip fields', function () {
    return Promise.all([
      this.app.client.isVisible(elements.KinoBetslipPreview).should.eventually.be.true,
      this.app.client.isVisible(elements.KinoBetslipAreaA).should.eventually.be.true,
      this.app.client.getText(elements.KinoBetslipAreaACost).should.eventually.be.equal('0,00€'),
