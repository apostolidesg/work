...
////////////////////////////////////////// Check functionality of Return to Main Menu option ///////////////////////////

describe('TC KinoStandardBetReturnToMainMenu.js: Check functionality of Return to Main Menu option', function () {
  ...
  it('Check Winnings table', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoWinningsTableKino1Winning).should.eventually.be.equal('3,75€'),
      this.app.client.getText(elements.KinoWinningsTableKino1KinoBonus).should.eventually.be.equal('78,75€'),
  ...
  it('Select Odd option of Kino Odd/Even game', function () {
    return this.app.client.click(elements.KinoOddEvenOdd).should.eventually.be.fulfilled;
  });

  it('Add selected Kino Odd/Even game to betslip', function () {
  ...
  it('Select 1st Columns of Kino Columns game', function () {
  ...
  it('Check betslip fields', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoBetslipAreaACost).should.eventually.be.equal('3,00€'),
      ...
      this.app.client.getText(elements.KinoBetslipAreaBCost).should.eventually.be.equal('3,00€'),
      ...
      this.app.client.getText(elements.KinoBetslipAreaCCost).should.eventually.be.equal('3,00€'),
      ...
      this.app.client.getText(elements.KinoBetslipAreaDCost).should.eventually.be.equal('3,00€'),
      ...
      this.app.client.getText(elements.KinoBetslipAreaECost).should.eventually.be.equal('3,00€'),
      ...
      this.app.client.getText(elements.KinoBetslipAreaFCost).should.eventually.be.equal('3,00€'),
  ...
  it('Check approve and print fields', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.KinoBetslipCost).should.eventually.be.equal('160€'),
    ]);
  });

  // if you have money on the balance field , then this question does not appear,
  /////////////// Select Return to Lobby and check that nothing is lost if player selects finally no /////////////////////

  it('Select digital play in order to have zero balance', function () {
    return this.app.client.click(elements.DigitalPay).should.eventually.be.fulfilled;
  });
  ...
  // if you have money on the balance field , then this question does not appear,
  it('Discard exit KINO game', function () {
    ...
    return Promise.all([
      this.app.client
        ...
        .should.eventually.be.equal('ΕΠΙΣΤΡΟΦΗ ΣΤΟ ΜΕΝΟΥ ΠΑΙΧΝΙΔΙΩΝ'),
      this.app.client
  ...
  /////////////// Select Return to Lobby and check that everything is cleared if player selects finally yes /////////////////////
  ...
  it('Check KINO Bonus checkbox', function () {
    return this.app.client.getValue(elements.KinoBonusCheckBox).should.eventually.be.equal('true');
  });
  ...
  /////////////////// Check return to Main Menu from Kino STandard Bet after idle time //////////////////////////////////
  ...
  it('Wait for idle timeout > 2 mins', function (done) {
    setTimeout(done, 125000);
  });
  ...
  it('Check elements of Lobby page', function () {
    return Promise.all([
  ...
  /////////////////// Check return to Main Menu from Kino Odd/Even page after idle time //////////////////////////////////
  ...
  /////////////////// Check return to Main Menu from Kino Columns Page after idle time //////////////////////////////////
