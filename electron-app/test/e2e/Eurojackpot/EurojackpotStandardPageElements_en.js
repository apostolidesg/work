...
describe('TC EurojackpotStandardPageElements_en.js: Check elements of Eurojackpot Bet Page', function () {
  ...
  //     this.app.client.getText(elements.EurojackpotScanError).should.eventually.be.equal('BARCODE READER ERROR'),
  //   ])
  // })
  ...
  it('Check T&C element and close with X', function() {
    let self=this;
    return Promise.all
              ([this.app.client.getText(elements.EurojackpotTCTitle).should.eventually.be.equal('TERMS & CONDITIONS'),
...
*/
  ...
  it('Check SSBT balance', function () {
    return this.app.client.getText(elements.EurojackpotBalanceHide).should.eventually.be.equal('Display Balance');
  });
  ...
  it('Check Clear All element', function () {
    return Promise.all([
      ...
      this.app.client.getText(elements.EurojackpotClearAllBtn).should.eventually.be.equal('CLEAR ALL'),
    ]);
  });
  ...
  it('Check message of consecutive draws fields calculator', function () {
    return this.app.client
      ...
      .getAttribute('innerText')
      .should.eventually.be.equal('Select from 1 to 52!');
  });
