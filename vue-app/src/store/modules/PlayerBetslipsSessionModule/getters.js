...
const getters = {
  ...
  [types.getters.GET_IS_NOT_BETSLIP_IN_SESSION]: ({ playerBetslips }) =>
    ({ serialNumber: inputSerialNumber } = {}) => playerBetslips.findIndex(({ serialNumber }) => inputSerialNumber === serialNumber) === -1,
